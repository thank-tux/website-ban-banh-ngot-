<?php
 ...
 foreach ($dssp as $sp) {
    ...
    <div class="thumbnail card">
        <div class="img-event">
           <a <a href="'.$link.'" >  <img class="group list-group-image img-fluid" src="uploads/product/'.$img.'" alt="" style=" width:" /></a>
        </div>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-lg-3">
            <div class="ab-info-grids">
                <h3 class="tittle text-center mb-lg-5 mb-3"><strong><?=$tendm?></strong></h3>
